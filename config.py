...
# ================ 数据文件路径 ================
DATA_FILES = {
    'sales_data': "C:\\Users\\何晴雅\\Desktop\\仪表盘原始数据.xlsx",  # 销售原始数据
    'sales_target': "C:\\Users\\何晴雅\\Desktop\\仪表盘销售月度指标维护.xlsx",  # 销售目标
    'customer_target': "C:\\Users\\何晴雅\\Desktop\\仪表盘客户月度指标维护.xlsx",  # 客户指标
    'tt_product_target': "C:\\Users\\何晴雅\\Desktop\\仪表盘TT产品月度指标.xlsx",  # TT产品指标
    'promotion': "C:\\Users\\何晴雅\\Desktop\\仪表盘促销活动.xlsx",  # 促销活动
    'inventory': "C:\\Users\\何晴雅\\Desktop\\仪表盘实时库存.xlsx",  # 实时库存
    'month_end_inventory': "C:\\Users\\何晴雅\\Desktop\\仪表盘月终月末库存.xlsx",  # 月末库存
    'forecast': "C:\\Users\\何晴雅\\Desktop\\仪表盘人工预测.xlsx",  # 人工预测
    'product_codes': "C:\\Users\\何晴雅\\Desktop\\仪表盘产品代码.txt",  # 产品代码列表
    'new_product_codes': "C:\\Users\\何晴雅\\Desktop\\仪表盘新品代码.txt",  # 新品产品代码
    'customer_relation': "C:\\Users\\何晴雅\\Desktop\\仪表盘人与客户关系表.xlsx",  # 客户关系表

    # 库存分析专用文件
    'batch_inventory': "C:\\Users\\何晴雅\\Desktop\\含批次库存.xlsx",  # 批次库存数据
    'shipping_data': "C:\\Users\\何晴雅\\Desktop\\出货数据.xlsx",  # 出货数据
    'inventory_forecast': "C:\\Users\\何晴雅\\Desktop\\人工预测.xlsx",  # 库存预测数据
    'price_data': "C:\\Users\\何晴雅\\Desktop\\单价.xlsx"  # 产品单价
}
...
def load_data_files():
    ...
    try:
        ...
        for file_key in ['customer_relation', 'promotion', 'sales_target', 'customer_target',
                         'tt_target', 'inventory', 'month_end_inventory', 'forecast']:
            if file_key in DATA_FILES and os.path.exists(DATA_FILES[file_key]):
                try:
                    df = pd.read_excel(DATA_FILES[file_key])
                    # 处理日期列
        ...
        for file_key in ['product_codes', 'new_product_codes']:
            if file_key in DATA_FILES and os.path.exists(DATA_FILES[file_key]):
                try:
                    with open(DATA_FILES[file_key], 'r', encoding='utf-8') as f:
...
def load_inventory_data():
    ...
    try:
        ...
        if os.path.exists(forecast_data_path):
            ...
            if len(forecast_data.columns) >= 5:
