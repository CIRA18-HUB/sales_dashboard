...
with col1:
    ...
    if sales_layer == 1:  # 第二层：图表分析
        ...
        <b>行动建议：</b> 进行更详细的分析，包括目标达成率、同比增长等关键指标。
        """)
...
with col2:
    ...
    if customer_layer == 1:  # 第二层：图表分析
        ...
        <b>行动建议：</b> 查看完整的客户价值分析、忠诚度和增长潜力评估。
        """)
...
with col3:
    ...
    if product_layer == 1:  # 第二层：图表分析
        ...
        if 'product_sales' in locals() and not product_sales.empty:
            ...
            <b>行动建议：</b> 查看完整的BCG矩阵分析、产品生命周期评估和未来产品规划建议。
            """)
        else:
...
with col1:
    ...
    if inventory_layer == 1:  # 第二层：图表分析
        ...
        if not inventory_data.empty:
            ...
            <b>行动建议：</b> 查看完整的库存周转分析，了解库存结构和老化风险，并获取优化建议。
            """)
        else:
...
with col2:
    ...
    if material_layer == 1:  # 第二层：图表分析
        ...
        if not expense_orders.empty:
            ...
            <b>行动建议：</b> 查看完整的物料使用效率分析，了解不同物料类型的ROI，优化物料策略。
            """)
        else:
...
with col3:
    ...
    if new_product_layer == 1:  # 第二层：图表分析
        ...
        if new_product_codes:
            ...
            <b>行动建议：</b> 查看完整的新品渗透分析，了解不同客户群体对新品的接受程度，优化新品推广策略。
            """)
        else:
