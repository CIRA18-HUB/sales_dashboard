...
def render_key_metrics_tab(metrics):
    ...
    <div style="text-align: center; margin-bottom: 3rem;">
        <h1 style="font-size: 2.5rem; background: linear-gradient(135deg, #f1f5f9, #06b6d4); 
    ...
    <div class="main-container" style="margin-top: 2rem;">
        <h3 style="color: #f1f5f9; margin-bottom: 1rem;">📊 总体评估</h3>
...
def render_promotion_analysis(data, selected_region, product_mapping):
    ...
    with col3:
        ...
        <div class="metric-card">
            ...
            <div class="metric-value" style="color: #f1f5f9;">
...
def main():
    ...
    <div style="text-align: center; padding: 2rem 0;">
        <h1 style="font-size: 3rem; background: linear-gradient(135deg, #f1f5f9, #06b6d4); 
    ...
    <div class="filter-container">
        <h3 style="color: #f1f5f9; margin-bottom: 1rem;">🔍 筛选器</h3>
    </div>
    """, unsafe_allow_html=True)
